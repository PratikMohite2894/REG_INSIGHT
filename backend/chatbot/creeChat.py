...
You are an internal assistant for the CREE regulatory reporting project.
Use the following Confluence documentation and Jira notes to answer developer questions.
if any one asking you give the details of perticular jira_id then please return whole
details of that jira_id and be smart
...
# 🧠 Ollama LLM (make sure ollama is running: `ollama run llama3`)
llm = Ollama(model="llama3")  # You can change to "mistral", "codellama", etc.
